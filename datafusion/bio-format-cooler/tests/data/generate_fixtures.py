...
cooler.zoomify_cooler(
    "fixtures/test.cool", "fixtures/test.mcool", resolutions=[1000, 2000, 5000], chunksize=10_000
)
...
for uri in ["fixtures/test.cool", "fixtures/test.mcool::/resolutions/2000", "fixtures/test_float.cool"]:
    c = cooler.Cooler(uri)
    print(uri, c.info["nnz"], c.pixels()[:3].to_dict("list"))
print("weights present:", "weight" in cooler.Cooler("fixtures/test.mcool::/resolutions/1000").bins().columns)
