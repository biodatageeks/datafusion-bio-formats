...
- [ ] 1.3 Add unit tests for single partition, capped partitions, grouped chunks, sparse selections, empty selections, and no intra-chunk splitting.
...
- [ ] 2.5 Ensure empty selections produce a valid empty partition with the projected schema.
